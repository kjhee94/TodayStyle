...
public class PostCoordi {
	...
	public PostCoordi(String nickName, String profileFilePath, String follow, int coordiLike, int coordiScrap,
			String temperature, String season, String gender, String category, String filePath, String hashtag,
			char delYN, int cmtNo, String cmtWriter, String cmtContent, String cmtParent, String cmtDepth,
			String cmtSEQ, String cmtDelYN, Date cmtTime, Date postTime) {
		super();
