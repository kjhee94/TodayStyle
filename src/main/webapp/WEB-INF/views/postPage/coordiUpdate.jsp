		...
		<div id="info-wrapper">
				...
				<div class="info-detail">
				    <div id="temperature">
                        <div class="subject">
                         ...
                         <select class="select">
                            <option>
                            	기온 선택<img src="/resources/images/icon/down.png" style="width:15px; height:15px; opacity:0.5; float:right">                            
                           	</option>
			...
			<div id="picture-wrapper">
	            <div id="insert-picture">
                        ...
                        <div class="insert-box" style="cursor:pointer; width:80%;float:left">
                        <input type="file" accept=".jpg, .png" name="uploadFile" id="uploadFile" multiple>
                    	<label for="file-input" style="width:100%;height:100%;cursor:pointer">
                            <em></em>
                            <p style="cursor:pointer;position:relative;top:200px">
                        ...
                        <div id="preview" style="width:20%;float:right">
