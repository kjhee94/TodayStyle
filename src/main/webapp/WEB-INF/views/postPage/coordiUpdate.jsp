...
<body>
	...
	<div id="wrap" style="overflow:auto">
		...
		<div id="title">
			<p style="font-size: 25px; color:#707070">코디수정</p>
		</div>
				
		<div id="info-wrapper" methos="get">
				...
				<div class="info-detail">
                    ...
                    <div class="togglebox">
	                       ...
	                       <a>
	                           	  <input type="button" value="봄" class="weather" name="season"/>
	                       </a>
	                       <a>
									<input type="button" value="여름" class="weather" name="season"/> 
	                       </a>
	                        <a>
	                        		<input type="button" value="가을" class="weather" name="season"/>
	                       </a>
	                        <a>
									<input type="button" value="겨울" class="weather" name="season"/>
	                       </a>
                     </div>
                     <div class="togglebox">
                           <div class="subject">
	                       ...
	                       <a>
								<input type="button" value="여자" class="gender" name="gender"/>
	                       </a>
	                        <a>
								<input type="button" value="남자" class="gender" name="gender"/>
	                        </a>
	                        <a>
								<input type="button" value="공용" class="gender" name="gender"/>
	                       </a>
                     </div>
                     <div id="coordi-info1">
                            <div class="subject">
